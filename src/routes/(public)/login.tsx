...
import logo from "@/assets/essencial-logo-small.webp";
	...
	return (
		<div className="w-screen h-screen flex flex-col justify-center items-center space-y-8">
			<div className="flex justify-center items-center gap-2">
				<img className="size-10" src={logo} alt="logo da Essencial" />
				<h1 className="text-3xl font-bold">Essential</h1>
			</div>
			<div className="min-w-[400px] flex flex-col items-center justify-between space-y-2 bg-white p-6 rounded-lg shadow-my-card">
